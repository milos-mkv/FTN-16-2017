...
public class CubeMap {
    ...
    public CubeMap(List<String> faces) throws RuntimeException {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            for (int i = 0; i < faces.size(); i++) {
                ...
                if (image == null) {
                    throw new RuntimeException("Failed to load image for CubeMap: " + faces.get(i));
                }

                GL32.glTexImage2D(
                        GL32.GL_TEXTURE_CUBE_MAP_POSITIVE_X + i,
                        0,
                        GL32.GL_RGB,
                        width.get(),
                        height.get(),
